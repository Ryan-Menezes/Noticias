		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						@if(can('edit.notices'))
							<a href="{{ route('panel.notices.edit', ['id' => $notice->id]) }}" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>
						@endif

						@if(can('delete.notices'))
							<a href="javascript:void(0)" class="btn btn-sm btn-danger btn-delete" data-route="{{ route('panel.notices.destroy', ['id' => $notice->id]) }}" data-bs-toggle="modal" data-bs-target="#modalDelete"><i class="fas fa-trash"></i></a>
						@endif
					</td>
				</tr>
				@endforeach
