...
return [
	'error' => [
		...
		'408' => 'Tempo de Solicitação Esgotado',				// Request Time-out
		'409' => 'Conflito',									// Conflict
		'410' => 'Perdido',										// Gone
		'411' => 'Duração Necessária',							// Length Required
		'412' => 'Falha de Pré-Condição',						// Precondition Failed
		'413' => 'Solicitação da Entidade Muito Extensa',		// Request Entity Too Large
		'414' => 'Solicitação de URL Muito Longa',				// Request-URL Too Large
		'415' => 'Tipo de Mídia Não Suportado',					// Unsupported Media Type
		'416' => 'Solicitação de Faixa Não Satisfatória',		// Request Range Not Satisfiable
		...
		'504' => 'Tempo Limite da Porta de Entrada',			// Gateway Time-out
